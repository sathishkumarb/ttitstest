            ...
            success: function (response) {
                if (response.status === 'success') {
                    ...
                    jQuery.each(areas, function (i, v) {
                        jQuery('#drawCanvas map#Map').append('<area shape="' + v.zoneType + '" id="' + v.zoneID + '" class="area" coords="' + v.zoneMaps + '" title="' + v.zoneTitle + '" data-dtcm="' + v.zoneDtcm + '" data-count="' + v.zoneCount + '" data-title="' + v.zoneTitle + '" data-price="' + v.zonePrice + '" data-type="' + v.zoneType + '">');
